...
pagination.pageCounterCreator.prototype.numberPages = function () {
    console.debug("BookJS::numberPages");
    if (this.needsUpdate) {
        this.value = 0;
...
pagination.createPages = function (num, flowName, pageCounterSelector) {
    console.debug("BookJS::createPages");
    var page, contents;
...
pagination.headersAndToc = function (bodyObjects) {
    console.debug("BookJS::headersAndToc");
...
pagination.createBodyObjects = function () {
    console.debug("BookJS::createBodyObjects");
...
pagination.flowObject = function (name, pageCounter) {
    console.debug("BookJS::flowObject");
...
pagination.flowObject.prototype.findTitle = function () {
    console.debug("BookJS::findTitle");
    var titleField;
...
pagination.flowObject.prototype.findStartpageNumber = function () {
    console.debug("BookJS::findStartpageNumber");
...
pagination.flowObject.prototype.addPagesLoop = function (pages) {
    console.debug("BookJS::addPagesLoop");
...
pagination.flowObject.prototype.addOrRemovePages = function (pages) {
    console.debug("BookJS::addOrRemovePages");
    if(!(this.namedFlow)) {
        this.setNamedFlow();
    }
    ...
    if ((this.namedFlow.overset) && (this.rawdiv.innerText.length > 0)) {
	    ...
	    console.debug("BookJS::dispatchEvent:bodyLayoutUpdatedEvent");
...
pagination.flowObject.prototype.removeExcessPages = function (pages) {
    console.debug("BookJS::removeExcessPages");
...
pagination.flowObject.prototype.enableAutoReflow = function () {
    console.debug("BookJS::enableAutoReflow");
    var flowObject = this;

    var reFlow = function () {
	if(pagination._disabled) return;
	console.debug("BookJS::reFlow");
...
pagination.applyBookLayout = function () {
    console.debug("BookJS::applyBookLayout");
    ...
    if (pagination.enableFrontmatter) {
	    ...
	    console.debug("BookJS::dispatchEvent:layoutFlowFinishedEvent");
...
//    bodyContainer = document.getElementById("dokument");
