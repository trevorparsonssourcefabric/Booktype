...
/*
    {
      text: "Edit",
      subMenu: ["undo", "redo", "underline", "subscript", "superscript"]
    }, 
*/
    {
      text: "Format",
      ...
      text: "Insert",
      subMenu: ["imageBrowser", 'insertFigure']
    }
/*
, {
      text: "Table",
...
*/
  ...
  toolbarSettings = ['bold', 'italic', 'underline', '', 'orderedList', 'unorderedList', 'outdentList', 'indentList', '', 'imageBrowser', '', 'tocButton', '', 'usersButton'];
//  toolbarSettings = ['bold', 'italic', 'underline', '', 'insertImage', 'insertFigure', '', 'orderedList', 'unorderedList', 'outdentList', 'indentList', '', 'usersButton'];
    ...
    */
    return Plugin.create("toolbar", {
      init: function() {
        ...
        /* ACO added */
        jQuery('<div class="topmenu"><!-- <span class="book-title">'+''+'</span> --> <span style="padding-left: 25px;" ><a name="toc" style="padding-top: 10px;" href="javascript:void(0)"><img src="/site_static/images/glyphicons_351_book_open.png"/></a></span><span class="chapter-title"></span><div class="userinfo">'+''+'</div><div class="savebutton"><a name="savebutton" href="javascript:void(0)">SAVE</a></div><div class="publishbutton"><a name="publishbutton" href="javascript:void(0)">PUBLISH</a></div></div>').appendTo(CONTAINER_JQUERY);

//        jQuery('<div class="topmenu"><span class="chapter-title">'+'aa'+'</span><div class="userinfo">'+'aa'+'</div></div>').appendTo(CONTAINER_JQUERY);
